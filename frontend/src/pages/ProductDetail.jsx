...
import { getProductBySlug } from "../services/api"; // Import your product data
    ...
    <Container className="my-16 md:my-24">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        {items.map((product) => {
          ...
          return (
            <div key={product.slug} className="flex flex-col items-center gap-8">
  ...
  if (loading) {
    return (
      <Container className="py-24">
        <h1 className="text-h2 text-center">Loading...</h1>
      </Container>
    );
  }
  ...
  return (
    <div>
      ...
      <Container className="flex flex-col md:flex-row items-center gap-12 lg:gap-24">
        ...
        <div className="flex-1">
          {product.newProduct && <span className="text-overline uppercase text-primary">New Product</span>}
      ...
      <Recommended items={product.others} />
