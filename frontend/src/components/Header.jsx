...
const CART_ICON_PATH = "/public/assets/shared/desktop/icon-cart.svg";
const HAMBURGER_ICON_PATH = "/public/assets/hamburger.svg";
...
const Header = () => {
  ...
  const NavLink = ({ to, children }) => (
    <Link
      to={to}
      className="text-sub-title uppercase tracking-2 font-bold hover:text-primary transition-colors"
  ...
  return (
    <header className="bg-black-light text-white z-50">
      <Container>
