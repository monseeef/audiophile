...
const CartQuantityInput = ({ item }) => {
  // TODO: Add logic to update quantity in context
  return (
    <div className="bg-gray-light flex items-center justify-between w-24 h-8">
      <button className="w-1/3 h-full text-black-full/50 hover:text-primary">-</button>
...
const CartModal = () => {
  const { cartItems, removeAll, total, cartCount, closeCartModal } = useCart();
