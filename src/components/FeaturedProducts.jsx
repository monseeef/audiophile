...
const zx9SpeakerImage = "/assets/home/desktop/image-speaker-zx9.png";
const zx7SpeakerImage = "/assets/home/desktop/image-speaker-zx7.jpg";
const yx1EarphonesImage = "/assets/home/desktop/image-earphones-yx1.jpg";
const circlePattern = "/assets/home/desktop/pattern-circles.svg";
...
const Zx9SpeakerAd = () => {
  return (
    <div className="bg-amber-600  rounded-lg p-6 md:p-12 lg:px-24 flex flex-col lg:flex-row items-center justify-between overflow-hidden relative">
      <img
        src={circlePattern}
        alt=""
      ...
      <div className="relative z-20 text-center lg:text-left text-white max-w-xs mt-8 lg:mt-0 lg:w-3/5 lg:pl-16">
        ...
        <Button
          ...
          variant="secondary"
          className="bg-black-full border-black-full text-white hover:bg-[#4C4C4C] hover:border-[#4C4C4C]"
        >
          See Product
        </Button>
      </div>
...
const Yx1EarphonesAd = () => {
  return (
    <div className="flex flex-col md:flex-row gap-6 md:gap-8">
      ...
      {/* Content Part */}
      <div className="w-full md:w-1/2 bg-gray-200 rounded-lg h-full min-h-[400px] flex items-center p-6 md:p-12 lg:px-24">
        <div>
